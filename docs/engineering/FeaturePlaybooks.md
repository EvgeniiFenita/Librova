...
Do not start coding until the feature maps to one of the remaining roadmap buckets in `docs/Librova-Roadmap.md`.
...
11. Update the relevant human-readable project docs:
    `docs/Librova-Product.md`, `docs/Librova-Architecture.md`, or `docs/Librova-Roadmap.md`.
12. Record the verified checkpoint in `docs/archive/Development-History.md`.
...
- the relevant human-readable project docs reflect the new stable reality
- `docs/archive/Development-History.md` records the verified checkpoint
